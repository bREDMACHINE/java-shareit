...
class ItemControllerTest {
    ...
    void addItem_ok() throws Exception {
        when(itemService.addItem(1L, itemDto1)).thenReturn(itemDto1);
        ...
        verify(itemService).addItem(1L, itemDto1);
    }

    @Test
    void updateItem_ok() throws Exception {
        when(itemService.updateItem(1L, 1L, updateItemDto1)).thenReturn(updateItemDto1);
        ...
        verify(itemService).updateItem(1L, 1L, updateItemDto1);
    }

    @Test
    void getItem_ok() throws Exception {
        when(itemService.getItem(1L, 1L)).thenReturn(itemOutDto);
    ...
    void findAllItems_ok() throws Exception {
        when(itemService.findAllItems(1L)).thenReturn(List.of(itemOutDto));
        ...
        verify(itemService).findAllItems(1L);
    }

    @Test
    void searchItems_ok() throws Exception {
        when(itemService.searchItems(1L, "text")).thenReturn(List.of(itemDto1));
        ...
        verify(itemService).searchItems(1L, "text");
    }

    @Test
    void addComment_ok() throws Exception {
        when(itemService.addComment(2L,1L, commentDto1)).thenReturn(commentDto1);
        ...
        verify(itemService).addComment(2L, 1L, commentDto1);
    }
}